...
<%@include file="/include/header.jsp"%>
	<div class="detail_container">
		...
		<section class="detail_content goods001">
			...
			<ul class="bxslider detail_slide">
				...
				<ul class="detail_panel">
					<li id="tab0" class="detail_panelList product_info">
						...
						<p class="desc_imgArea">
							<img src="/asset/img/goods_img/goods001_img0.jpg" alt="weekly 이미지0" />
						</p>
						<p class="desc_textArea">
							<strong>Weekly Market</strong><br/>
								<span>ES CHOCOLATE</span>
								<span class="detail_descText">
								모모스커피의 시그니처 블렌딩으로 에스프레소 및 다양한 베리에이션으로 많은 사랑을 받고 있습니다.<br/>
								다크초콜릿과 헤이즐넛의 달콤쌉싸래함이 크리미한 촉감과 함께 라운드하게 느껴집니다.<br/>
								풍부하고 밀도 높은 바디감은 물론, 깊은 단맛이 오래동안 여운으로 남는 커피 입니다. 
								</span>
						</p>
						<div class="coffee_info">
							...
							<ol>
								...
								<li class="single4">
									<p class="singleIcon"><img src="img/icons/farmIcon.png" alt="농장 아이콘"/></p>
									<p class="singleText">농장 /<br/><span class="singleGray">알제리아</span></p>
								</li>
								<li class="single4">
									<p class="singleIcon"><img src="img/icons/raceIcon.png" alt="품종 아이콘"/></p>
									<p class="singleText">품종 /<br/><span class="singleGray">카투라</span></p>
								</li>
								<li class="single4">
									<p class="singleIcon"><img src="img/icons/processIcon.png" alt="가공방식 아이콘"/></p>
									<p class="singleText">가공방식 /<br/><span class="singleGray">워시드</span></p>
								</li>
								<li class="singleFlovar">
									<p class="singleIcon"><img src="img/icons/flovarIcon.png" alt="향미 아이콘"/></p>
									<p class="singleText">
										향미 / 
...
<%-- 
	<?php  echo "<meta http-equiv='Refresh' content='3000; url=php/03_1_logout.php'/>"; }?>
--%>
